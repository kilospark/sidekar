...
BINARY="sidekar"
OLD_BINS="sidekar-mcp sidekar-rs webact webact-mcp webact-rs"
...
for rc in "$HOME/.zshrc" "$HOME/.bashrc" "$HOME/.bash_profile"; do
  if [ -f "$rc" ]; then
    for marker in "# Added by sidekar installer" "# Added by webact installer" "# Added by webact-mcp installer"; do
